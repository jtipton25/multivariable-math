...
$$
\begin{aligned}
`r array_to_latex(cbind(A - lambda[1] * diag(nrow(A)), 0))` & \stackrel{rref}{\sim} `r array_to_latex(rref(cbind(A - lambda[1] * diag(nrow(A)), 0)))`
\end{aligned}
$$
which has solution 
$$
...
$$
\begin{aligned}
`r array_to_latex(cbind(A - lambda[2] * diag(nrow(A)), 0))` & \stackrel{rref}{\sim} `r array_to_latex(rref(cbind(A - lambda[2] * diag(nrow(A)), 0)))`
\end{aligned}
$$
which has solution 
$$
...
$$
\begin{aligned}
`r array_to_latex(cbind(A - lambda[3] * diag(nrow(A)), 0))` & \stackrel{rref}{\sim} `r array_to_latex(rref(cbind(A - lambda[3] * diag(nrow(A)), 0)))`
\end{aligned}
$$
which has solution 
$$
...
$$
\begin{aligned}
`r array_to_latex(cbind(A - lambda * diag(nrow(A)), 0))` & \stackrel{rref}{\sim} `r array_to_latex(rref(cbind(A - lambda * diag(nrow(A)), 0)))`
\end{aligned}
$$
which has solution 
$$
