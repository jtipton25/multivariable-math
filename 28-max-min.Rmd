        ...
        plot_ly(x = x, y = y, z = matrix(dat$z, 40, 40)) %>%
            ...
            add_trace(x = critical_points$x, y = critical_points$y, 
                      ...
                      marker = list(size = 5, 
                                    ...
                                    symbol = 104),
                      name = c("local maximum", rep("saddle point", 4))),
        file = "./images/critical.html")
    webshot2::webshot(url = "./images/critical.html", 
                      file = "./images/critical.png", 
                      delay = 1, zoom = 4, vheight = 500)
    knitr::include_graphics("./images/critical.png")
        ...
        plot_ly(x = x, y = y, z = matrix(dat$z, 40, 40)) %>%
            ...
            add_trace(x = critical_points$x, y = critical_points$y, 
                      ...
                      marker = list(size = 5, 
                                    ...
                                    symbol = 104),
                      name = "saddle point"),
        file = "./images/saddle.html")
    webshot2::webshot(url = "./images/saddle.html", 
                      file = "./images/saddle.png", 
                      delay = 1, zoom = 4, vheight = 500)
...
A saddle point of a differentiable function $f(x, y)$ is a critical point $(a, b)$ of $f(x, y)$ where for all $\epsilon > 0$ there exists points $(x, y)$ within the disk of radius $\epsilon$ of the point $(a, b) ($\|(x, y) - (a, b)\| < \epsilon$) where $f(x, y) > f(a, b)$ and where $f(x, y) < f(a, b)$. In other words, there are points nearby the critical point that have both higher and lower values than the value $f(a, b)$. 
```
...
plot_ly(x = x, y = y, z = matrix(dat$z, 40, 40)) %>%
    ...
    add_trace(x = critical_points$x, y = critical_points$y, 
              ...
              marker = list(size = 5, 
                            ...
                            symbol = 104),
              name = "saddle point"),
        file = "./images/saddle2.html")
    webshot2::webshot(url = "./images/saddle2.html", 
                      file = "./images/saddle2.png", 
                      delay = 1, zoom = 4, vheight = 500)
    knitr::include_graphics("./images/saddle2.png")
