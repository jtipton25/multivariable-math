    ...
    htmlwidgets::saveWidget(
        plot_ly(x = x, y = y, z = matrix(dat$z, 40, 40)) %>%
            ...
            add_trace(x = critical_points$x, y = critical_points$y, 
                      ...
                      name = c("local maximum", rep("saddle point", 4))),
        file = "critical.html")
    webshot2::webshot(url = "critical.html", 
                      file = "critical.png", 
                      delay = 1, zoom = 4, vheight = 500)
    knitr::include_graphics("critical.png")
    ...
    htmlwidgets::saveWidget(
        plot_ly(x = x, y = y, z = matrix(dat$z, 40, 40)) %>%
            ...
            add_trace(x = critical_points$x, y = critical_points$y, 
                      ...
                      name = "saddle point"),
        file = "saddle.html")
    webshot2::webshot(url = "saddle.html", 
                      file = "saddle.png", 
                      delay = 1, zoom = 4, vheight = 500)
    knitr::include_graphics("saddle.png")
...
plot_ly(x = x, y = y, z = matrix(dat$z, 40, 40)) %>%
    ...
    add_trace(x = critical_points$x, y = critical_points$y, 
              ...
              name = "saddle point"),
        file = "saddle2.html")
    webshot2::webshot(url = "saddle2.html", 
                      file = "saddle2.png", 
                      delay = 1, zoom = 4, vheight = 500)
    knitr::include_graphics("saddle2.png")
