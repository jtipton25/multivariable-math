...
\end{aligned}
$$
The matrix inverse $\mathbf{C}^{-1}$ can be found using theorem \@ref(thm:matrix-2by2) to get $\mathbf{C}^{-1} = `r array_to_latex(C_inv)`$. Then, plugging in the values from the example gives 
