...
\begin{align*}
& & `r array_to_latex(L1)` & \stackrel{r_2 \leftarrow -\frac{1}{2} r_2 - r_1}{\huge \sim} & `r array_to_latex(L2)` \\
& \stackrel{r_3 \leftarrow - r_3 - r_1}{\huge \sim} & `r array_to_latex(L3)` & \stackrel{r_4 \leftarrow - \frac{1}{2} r_4 - r_1}{\huge \sim} & `r array_to_latex(L4)` \\
& \stackrel{r_2 \leftarrow 2 r_2}{\huge \sim} & `r array_to_latex(L5)` & \stackrel{r_3 \leftarrow \frac{1}{2} r_3 - r_2}{\huge \sim} & `r array_to_latex(L6)` \\
& \stackrel{r_4 \leftarrow \frac{2}{3} r_4 - r_2}{\huge \sim} & `r array_to_latex(L7)` & \stackrel{r_3 \leftarrow \frac{2}{3} r_3}{\huge \sim} & `r array_to_latex(L8)` 
\end{align*}
...
\begin{align*}
& & `r array_to_latex(U1)` & \stackrel{r_2 \leftarrow \frac{1}{2} r_2}{\huge \sim} & `r array_to_latex(U2)` \\
& \stackrel{r_3 \leftarrow \frac{1}{2} r_3}{\huge \sim} & `r array_to_latex(U3)` & \stackrel{r_4 \leftarrow - \frac{1}{3} r_4}{\huge \sim} & `r array_to_latex(U4)` \\
& \stackrel{r_1 \leftarrow r_1 -2  r_3}{\huge \sim} & `r array_to_latex(U5)` & \stackrel{r_1 \leftarrow r_1 - 2 r_4}{\huge \sim} & `r array_to_latex(U6)` \\
& \stackrel{r_2 \leftarrow r_2 - \frac{3}{2} r_4}{\huge \sim} & `r array_to_latex(U7)` & 
\stackrel{r_3 \leftarrow r_3 + \frac{3}{2} r_4}{\huge \sim} & `r array_to_latex(U8)` 
\end{align*}
...
```
\begin{align*}
& & `r array_to_latex(A1)` & \stackrel{r_2 \leftarrow r_2 + 2 r_1}{\huge \sim} & `r array_to_latex(A2)` \\
& \stackrel{r_3 \leftarrow r_3 + r_1}{\huge \sim} & `r array_to_latex(A3)` & \stackrel{r_4 \leftarrow r_4 + 2 r_1}{\huge \sim} & `r array_to_latex(A4)` \\
& \stackrel{r_2 \leftarrow - \frac{1}{2} r_2}{\huge \sim} & `r array_to_latex(A5)` & \stackrel{r_3 \leftarrow r_3 + 4 r_2}{\huge \sim} & `r array_to_latex(A6)` \\
& \stackrel{r_4 \leftarrow r_4 + 6 r_2}{\huge \sim} & `r array_to_latex(A7)` & 
\stackrel{r_3 \leftarrow - \frac{1}{6} r_3}{\huge \sim} & `r array_to_latex(A8)`\\
& \stackrel{r_4 \leftarrow \frac{1}{9} r_4}{\huge \sim} & `r array_to_latex(A9)` & \stackrel{r_1 \leftarrow r_1 - 2 r_3}{\huge \sim} & `r array_to_latex(A10)` \\
& \stackrel{r_1 \leftarrow r_1 - r_4}{\huge \sim} & `r array_to_latex(A11)` & 
\stackrel{r_2 \leftarrow r_2 - \frac{3}{2} r_4}{\huge \sim} & `r array_to_latex(A12)` \\
& \stackrel{r_3 \leftarrow r_3 + \frac{3}{2} r_4}{\huge \sim} & `r array_to_latex(A13)`  
\end{align*}
