...
\end{aligned}
$$
Thus, the basis for 3-eigenspace is $\left\{ `r array_to_latex(c(-4, 1, 0))`, `r array_to_latex(c(3, 0, 1))`\right\}$. Note that this is the same as finding a bais for the null space of $\right(\mathbf{A} - \lambda \mathbf{I} \right)$.
