...
:::{.theorem #matrix-2by2 name="Matrix Inverse for 2 by 2 matrix"}
...
:::{.theorem #invertible-matrix1 name="Invertible Matrix Theorem"}
...
* **Note:** A consequence of theorem \@ref(thm:invertible-matrix1) (2) is that the product of $k$ invertible $n \times n$ matrices $\mathbf{A}_1 \mathbf{A}_2 \cdots \mathbf{A}_k$ has inverse $\mathbf{A}_k^{-1} \mathbf{A}_{k-1}^{-1} \cdots \mathbf{A}_1^{-1}$
