...
```{definition, matrix-inverse, name = "Matrix Inverse"}
...
```{theorem, invertible-matrix-1, name = "Invertible Matrix Theorem"}
...
<div class="toggle"><button>Show Proof</button>
:::{.proof}
...
* **Note:** A consequence of theorem \@ref(thm:invertible-matrix-1) (2) is that the product of $k$ invertible $n \times n$ matrices $\mathbf{A}_1 \mathbf{A}_2 \cdots \mathbf{A}_k$ has inverse $\mathbf{A}_k^{-1} \mathbf{A}_{k-1}^{-1} \cdots \mathbf{A}_1^{-1}$
...
<div class="toggle"><button>Proof</button>
:::{.proof}
**Proof: in class**
:::
</div>
